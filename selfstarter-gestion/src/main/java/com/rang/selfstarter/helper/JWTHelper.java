package com.rang.selfstarter.helper;
...
import static com.rang.selfstarter.constant.JWTUtil.*;
...
public class JWTHelper {
    ...
    //extract token from the request's header
    //Bearer is the prefix that the front end application sends before the token
    ...
    //place accessToken and refreshToken in a map
